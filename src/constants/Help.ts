...
export const helpCommands = {
    ...
    bingo: `(Staff Only) Inicie uma partida de bingo. Para ganhar é necessário fazer uma linha ou uma coluna. Uso: \`\`\`${prefix}bingo tempoAtéComeçar tamanhoDaTabela premio\`\`\``,
    danki: `Enviará um meme da Danki! Uso: \`\`\`${prefix}danki\`\`\``,
    brainfuck: `Um interpretador (meio ruim) de Brainfuck. Uso: \`\`\`${prefix}brainfuck +++[>+++++<-]>[>+++++<-]>+++.+.-.---------.\`\`\``
};
